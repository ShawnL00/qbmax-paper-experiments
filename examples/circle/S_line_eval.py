...
def preprocess_arrays(
    actx, sources, targets, centers_in, centers_out,
    weights_nodes, expansion_radii, normal
):
...
def run_comparison(lams, taus, nelement, target_order, expn_order, upsampling_factor):
    ...
    (sources, targets, centers_in, centers_out, _weights_nodes,
     expansion_radii, _normal) = processed_arrays
...
def main():
    ...
    visualize_results(
        qbmax_results, qbx_results, lams, taus, nelement,
        expn_order, target_order, upsampling_factor
    )
